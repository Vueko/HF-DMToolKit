...
const MOODS: { mood: Mood; label: string; active: string; inactive: string }[] = [
    { mood: 'calm',    label: 'dashboard.moodCalm',    active: 'bg-blue-500/40 text-blue-100 border-blue-400 shadow-[0_0_8px_rgba(59,130,246,0.4)]',       inactive: 'bg-blue-500/10 text-blue-400 border-blue-500/40 hover:bg-blue-500/20' },
    { mood: 'tense',   label: 'dashboard.moodTense',   active: 'bg-red-500/40 text-red-100 border-red-400 shadow-[0_0_8px_rgba(239,68,68,0.4)]',            inactive: 'bg-red-500/10 text-red-400 border-red-500/40 hover:bg-red-500/20' },
    { mood: 'epic',    label: 'dashboard.moodEpic',    active: 'bg-yellow-500/40 text-yellow-100 border-yellow-400 shadow-[0_0_8px_rgba(234,179,8,0.4)]',   inactive: 'bg-yellow-500/10 text-yellow-400 border-yellow-500/40 hover:bg-yellow-500/20' },
    { mood: 'mystery', label: 'dashboard.moodMystery', active: 'bg-purple-500/40 text-purple-100 border-purple-400 shadow-[0_0_8px_rgba(168,85,247,0.4)]',  inactive: 'bg-purple-500/10 text-purple-400 border-purple-500/40 hover:bg-purple-500/20' },
    { mood: 'ambient', label: 'dashboard.moodAmbient', active: 'bg-green-500/40 text-green-100 border-green-400 shadow-[0_0_8px_rgba(34,197,94,0.4)]',     inactive: 'bg-green-500/10 text-green-400 border-green-500/40 hover:bg-green-500/20' },
]
